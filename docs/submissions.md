...
For rungs involving classification, the models' accuracy, precision, and confusion matrix will be evaluated. For rungs involving regression, the grading scheme is identical to that of [Ding et al. 2021](https://ui.adsabs.harvard.edu/abs/2021MNRAS.503.1096D/abstract), section 2.7. For transparency, the notebooks used to grade the submissions are shown [here](https://github.com/ahuang314/Roman_Data_Challenge/blob/main/Notebooks/).
