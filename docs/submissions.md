...
For rungs involving classification, the models' precision, recall, and f2 score will be evaluated. For rungs involving regression, the grading scheme is similar to that of [Ding et al. 2021](https://ui.adsabs.harvard.edu/abs/2021MNRAS.503.1096D/abstract).
